...
const AdminDishCard = ({image , category,price,title,desc,rating,Isveg}) => {
  return (
    ...
    <div className="relative">
      <img
        src={image}
        className="w-full h-[250px]  object-cover transition-transform rounded-2xl duration-300 group-hover:scale-105"
        alt={title}
      />
